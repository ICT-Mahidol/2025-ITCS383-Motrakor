      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            ...
            child: const Text('Login', style: TextStyle(color: SteamJekTheme.text)),
          ),
        ],
      ),
      body: _loading 
        ...
        : Column(
            children: [
               Container(
                 ...
                 child: Column(
                   children: [
                     const Icon(Icons.videogame_asset, size: 64, color: SteamJekTheme.accent),
                     const SizedBox(height: 16),
                     const Text('Welcome to SteamJek', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white)),
                     const SizedBox(height: 8),
                     const Text('Discover, play, and connect.', style: TextStyle(color: SteamJekTheme.muted, fontSize: 16)),
               ...
               const Padding(
                 ...
                 child: Align(
                   ...
                   child: Text('FEATURED & RECOMMENDED', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: SteamJekTheme.muted2)),
                 ),
               ),
               Expanded(
                   ...
                   itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          title: Text(game['title'] ?? 'Unknown', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                          subtitle: Padding(
                          ...
                          trailing: Container(
                            ...
                            child: Text('\$${game['price']}', style: const TextStyle(color: SteamJekTheme.green, fontWeight: FontWeight.bold)),
                          ),
                          onTap: () {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            TextField(controller: _password, decoration: const InputDecoration(labelText: 'Password', prefixIcon: Icon(Icons.lock)), obscureText: true),
            const SizedBox(height: 24),
            SizedBox(
              width: double.infinity,
              height: 50,
            ...
            TextButton(
              ...
              child: Text('Don\'t have an account? Register', style: TextStyle(color: SteamJekTheme.accent)),
            )
          ],
        ),
      ),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            TextButton(
              onPressed: () => Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const LoginScreen())),
              child: Text('Already have an account? Login', style: TextStyle(color: SteamJekTheme.accent)),
            )
          ],
        ),
      ),
          ...
          return Card(
            ...
            child: ListTile(
              ...
              trailing: Container(
                ...
                child: Text('\$${game['price']}', style: TextStyle(color: SteamJekTheme.green, fontWeight: FontWeight.bold)),
              ),
    ...
    try {
      ...
      await Stripe.instance.initPaymentSheet(
        paymentSheetParameters: SetupPaymentSheetParameters(
          ...
          appearance: const PaymentSheetAppearance(colors: PaymentSheetAppearanceColors(background: SteamJekTheme.bg2)),
        ),
      );
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text('\$${item['price'] ?? '0.00'}', style: TextStyle(color: SteamJekTheme.green)),
                    trailing: IconButton(
          ...
          if (_cart.isNotEmpty)
            Padding(
              ...
              child: SizedBox(
                width: double.infinity,
                height: 50,
                child: ElevatedButton(onPressed: _checkout, child: const Text('CHECKOUT NOW')),
              ),
            )
        ],
      ),
